...
<iframe
    ...
    frameborder="0"
></iframe>
The distribution above demonstrates that we have significant evidence to reject the null hypothesis that the proportion recipes that are macro-friendly (proteins per calorie = 0.25) and have an average rating of at least 4.0 stars is equal to 0.5.
